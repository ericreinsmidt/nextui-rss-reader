...
int main(int argc, char* argv[]) {
    ...
    log_line("==== nextfeed article detail stage starting ====");
            ...
            {
                {
                    "HN Article 1",
                    {
                        ...
                        "It simulates a summary or content view.",
                        "NextFeed will eventually render cached feed items.",
                        "Line 4 of the article body.",
                        "Line 5 of the article body.",
                        "Line 6 of the article body.",
                        "Line 7 of the article body.",
                        "Line 8 of the article body."
                    }
                },
                {
                    "HN Article 2",
                    {
                        "Another article from the Hacker News feed.",
                        "This view will later show parsed article summaries.",
                        "Scrolling should work with the D-pad.",
                        "More placeholder text here.",
                        "Even more placeholder text here."
                    }
                },
                {
                    "HN Article 3",
                    {
                        "Third Hacker News article placeholder.",
                        "The goal is to validate navigation and layout."
                    }
                }
            }
        },
            ...
            {
                {
                    "GNOME Post 1",
                    {
                        "Planet GNOME placeholder article content.",
                        "This will eventually be normalized from RSS or Atom."
                    }
                },
                {
                    "GNOME Post 2",
                    {
                        "Second GNOME placeholder article.",
                ...
                },
                {
                    "GNOME Post 3",
                    {
                        "Third GNOME placeholder article."
                    }
                }
            }
        },
            ...
            {
                {
                    "LWN Story 1",
                    {
                        "LWN placeholder article body line 1.",
                        "LWN placeholder article body line 2.",
                        "LWN placeholder article body line 3."
                    }
                },
                {
                    "LWN Story 2",
                    {
                        "Second LWN article placeholder."
                    }
                },
                {
                    "LWN Story 3",
                    {
                        "Third LWN article placeholder."
                    }
                }
            }
        }
            ...
            if (event.type == SDL_JOYBUTTONDOWN) {
                if (event.jbutton.button == 1) {
                    if (screen == Screen::FeedList) {
                        ...
                        article_scroll = 0;
                        log_line("Open article detail");
                    }
                } else if (event.jbutton.button == 0) {
                    if (screen == Screen::ArticleDetail) {
                        screen = Screen::ArticleList;
                        log_line("Back to article list");
                    } else if (screen == Screen::ArticleList) {
    ...
    log_line("==== nextfeed article detail stage exiting cleanly ====");
    return 0;
}
'''

(ROOT / "src/main.cpp").write_text(main_cpp, encoding="utf-8")
print("Article detail stage written.")
